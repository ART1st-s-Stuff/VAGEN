...
class NavigationEnv(GymImageEnv):
    ...
    def _sync_step(self, action_str: str) -> Tuple[Dict[str, Any], float, bool, Dict[str, Any]]:
        ...
        info.update({
            ...
            "action_space_names": list(ACTION_LOOKUP),
            "executed_action_names": list(self._valid_actions),
            "executed_action_ids": [ACTION_LOOKUP[action] - 1 for action in self._valid_actions],
