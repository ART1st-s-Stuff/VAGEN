"""Human-approved non-production escape hatch for ID169 DP8 smoke only."""
...
JOINT_INTEGRATION_GATE_IMPLEMENTATION = "id169_dp8_resume_smoke_v1"
...
class JointIntegrationGate:
    ...
    def __post_init__(self) -> None:
        ...
        if self.experiment_id != 169:
            raise ValueError("joint integration gate is restricted to experiment 169")
