...
experiment_name="navigation_vagen1_ac_success_guarded_turn20_ctx8192_60step_${RUN_STAMP}"
env_config="scripts/examples/vagen_base/navigation_vagen1/env_config_dense_ac_success_guarded.yaml"
tags="vagen,navigation,vagen1,step1,local-env,8gpu,turn20,ctx8192,w1,rmb2,default-loss,fmt005,ac-success,guarded,save15,raw-samples"
...
echo "| --- | --- | --- | --- |"
echo "| ac_success_guarded | $job_id | $experiment_name | $env_config |"
